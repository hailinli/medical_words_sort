...
WORD_FREQ_PRE = '%s/data_pre_handle/UMLS/词频_pre.txt' % MEDICAL_WORDS_SORT_ROOT   # 词频文件
MEDICAL_ETYMA = '%s/医学英语资源-非压缩版/词根词缀表.txt' % MEDICAL_WORDS_SORT_ROOT   # 医学词典
MEDICAL_ETYMA_PRE = '%s/data_pre_handle/词根词缀表_pre.txt' % MEDICAL_WORDS_SORT_ROOT
MEDICAL_ETYMA_FREQ_PRE = '%s/data_pre_handle/词根词缀频率表.txt' % MEDICAL_WORDS_SORT_ROOT
MEDICAL_ETYMA_WORD = '%s/data_pre_handle/词缀_单词关联表.txt' % MEDICAL_WORDS_SORT_ROOT
MEDICAL_ETYMA_WORD_RE = '%s/data_pre_handle/单词_词缀关联表.txt' % MEDICAL_WORDS_SORT_ROOT
MEDICAL_WORD_GROUP = '%s/医学英语资源-非压缩版/UMLS/umls-medical english phrase(804W+).txt' % MEDICAL_WORDS_SORT_ROOT
MEDICAL_WORD_GROUP_FREQ = '%s /medical_words_sort/data_pre_handle/词组各词频率表.txt' % MEDICAL_WORDS_SORT_ROOT
MEDICAL_WORD_GROUP_FREQ_USE  = '%s/data_pre_handle/词组各词频率表(useful).txt' % MEDICAL_WORDS_SORT_ROOT
